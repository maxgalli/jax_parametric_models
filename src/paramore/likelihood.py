...
def create_extended_nll(params, sum_pdf: SumPDF, data: Float[Array, "N"]) -> Float[Array, ""]:
    ...
    extended_vals = sum_pdf.extended_vals.value if hasattr(sum_pdf.extended_vals, 'value') else sum_pdf.extended_vals
